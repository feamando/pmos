...
FRAMEWORKS_DIR = REPO_ROOT / "AI_Guidance" / "Frameworks"
...
"""
    ...
    options_table = "\n".join(options_rows) if options_rows else "| (No options evaluated) | - | - | - |"
...
"""
    ...
    if "## References" in document:
        ...
        return document.replace("## Decision Rationale", faq_section + "\n## Decision Rationale")
    else:
        return document + "\n" + faq_section
...
def main():
    ...
    parser.add_argument(
        "--list-sections",
        action="store_true",
        help="List sections in a template"
    )
    parser.add_argument(
        "--get-template",
        action="store_true",
        help="Output raw template"
    )
    parser.add_argument(
        "--render",
        action="store_true",
        help="Render template with context"
    )
    parser.add_argument(
        "--context",
        type=str,
    ...
    parser.add_argument(
        "--fpf",
        action="store_true",
        help="Include FPF reasoning sections"
    )
    parser.add_argument(
        "--orthogonal",
        action="store_true",
        help="Include orthogonal challenge FAQ"
    )
    parser.add_argument(
        "--json",
        action="store_true",
    ...
    if args.render:
        ...
        rendered = render_template(
            args.type,
            context,
            include_fpf=args.fpf,
            include_orthogonal=args.orthogonal
        )
