...
def validate_claude_code() -> Tuple[bool, str]:
    ...
    required_skills = [
        "q0-init.md", "q1-hypothesize.md", "q2-verify.md",
        "q3-validate.md", "q4-audit.md", "q5-decide.md",
        "quint-sync.md"
    ]
...
def validate_gemini_cli() -> Tuple[bool, str]:
    ...
    required_commands = [
        "fpf-init.toml", "fpf-hypothesize.toml", "fpf-verify.toml",
        "fpf-validate.toml", "fpf-audit.toml", "fpf-decide.toml"
    ]
    ...
    return True, f"Gemini CLI: MCP configured, {len(required_commands)} commands present"
...
def validate_codex_cli() -> Tuple[bool, str]:
    ...
    required_prompts = [
        "fpf-init.md", "fpf-hypothesize.md", "fpf-verify.md",
        "fpf-validate.md", "fpf-audit.md", "fpf-decide.md"
    ]
