...
Fetch GitHub activity (PRs, commits) for New Ventures squads and enrich Brain context.
...
python3 AI_Guidance/Tools/github_brain_sync.py --summarize

# Specific squad
python3 AI_Guidance/Tools/github_brain_sync.py --squad "Good Chop"

# Deep analysis with file changes
python3 AI_Guidance/Tools/github_brain_sync.py --analyze-files

# Update project Technical Context from READMEs
python3 AI_Guidance/Tools/github_brain_sync.py --update-projects
```
