...
python3 AI_Guidance/Tools/file_chunker.py --check <FILE>

# Split a large file
python3 AI_Guidance/Tools/file_chunker.py --split <FILE>

# Scan directory for large files
python3 AI_Guidance/Tools/file_chunker.py --scan AI_Guidance/Brain/Inbox
```
