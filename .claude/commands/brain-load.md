...
python3 AI_Guidance/Tools/brain_loader.py --query "OTP launch"

# Validate registry integrity
python3 AI_Guidance/Tools/brain_loader.py --validate

# List all entities
python3 AI_Guidance/Tools/brain_loader.py --list-all

# Scripting: get file paths only
python3 AI_Guidance/Tools/brain_loader.py --files-only
```
...
- **Beatrice** (8 mentions) [EXISTS]
  File: `Brain/Entities/Beatrice_Dimarucut.md`

============================================================
Files to load:
  - Brain/Projects/OTP.md
  - Brain/Entities/Beatrice_Dimarucut.md
============================================================
```
