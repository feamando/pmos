...
```bash
# Check all evidence
python3 AI_Guidance/Tools/evidence_decay_monitor.py

# Generate markdown report
python3 AI_Guidance/Tools/evidence_decay_monitor.py --report

# JSON output for automation
python3 AI_Guidance/Tools/evidence_decay_monitor.py --json

# Cron-compatible (exit codes: 0=OK, 1=Critical, 2=Expired)
python3 AI_Guidance/Tools/evidence_decay_monitor.py --cron --days 14
```
