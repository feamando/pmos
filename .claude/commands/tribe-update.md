...
Parse the arguments:
- **Standard mode:** `/tribe-update` or `/tribe-update New Ventures` - Fast generation
...
1. Run the tribe update generator:
   ```bash
   python3 AI_Guidance/Tools/tribe_quarterly_update.py --tribe "New Ventures"
   ```
...
1. Run the orthogonal challenge:
   ```bash
   python3 AI_Guidance/Tools/tribe_quarterly_update.py --tribe "New Ventures" --orthogonal
   ```
...
1. **Brain/Projects/**: OTP, VMS, Good_Chop, TPT, Factor_Form related files
2. **Brain/Entities/**: Squad files for each New Ventures squad
...
2. **Owner:** Tribe Lead (Nikita Gorshkov)
...
```
/tribe-update --squad "Good Chop"
```

**Full example with all parameters:**
```
python3 AI_Guidance/Tools/tribe_quarterly_update.py --tribe "New Ventures" --quarter Q1-2026 --prev-quarter Q4-2025
```
...
- Template based on HelloTech Tribe Quarterly Planning Update Template
