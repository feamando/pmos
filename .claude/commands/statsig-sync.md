...
```bash
python3 AI_Guidance/Tools/statsig_brain_sync.py --active-only
```
...
python3 AI_Guidance/Tools/statsig_brain_sync.py --deep

# Preview without writing
python3 AI_Guidance/Tools/statsig_brain_sync.py --active-only --dry-run

# With summary output
python3 AI_Guidance/Tools/statsig_brain_sync.py --active-only --summary-file experiments_summary.md
```
...
1. Extracts Jira keys from experiment name/description (e.g., `GOC-123`)
