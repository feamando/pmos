...
Run the sprint report generator for New Ventures squads:

```bash
python3 AI_Guidance/Tools/sprint_report_generator.py
```
...
```bash
# All New Ventures squads
python3 AI_Guidance/Tools/sprint_report_generator.py

# Specific squad
python3 AI_Guidance/Tools/sprint_report_generator.py --squad "Good Chop"

# Custom output
python3 AI_Guidance/Tools/sprint_report_generator.py --output "my_report.csv"
```
