...
6. Create BC document:
   ```bash
   python3 AI_Guidance/Tools/template_manager.py --type bc --render --fpf
   ```
...
1. Run the orthogonal challenge system:
   ```bash
   python3 AI_Guidance/Tools/orthogonal_challenge.py --type bc --topic "$ARGUMENTS"
   ```
...
**Standard:**
- `/bc Expand to Canadian market with Good Chop`
- `/bc Launch mobile app for TPT customers`
