...
6. Create PRFAQ document:
   ```bash
   python3 AI_Guidance/Tools/template_manager.py --type prfaq --render --fpf
   ```
...
1. Run the orthogonal challenge system:
   ```bash
   python3 AI_Guidance/Tools/orthogonal_challenge.py --type prfaq --topic "$ARGUMENTS"
   ```
...
**Standard:**
- `/prfaq Push notifications for TPT app`
