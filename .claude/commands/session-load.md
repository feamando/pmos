...
```bash
python3 AI_Guidance/Tools/session_manager.py --load "SESSION_ID"
```
...
```bash
python3 AI_Guidance/Tools/session_manager.py --list 5
```

2. Show options to user and ask which to load, OR
3. Load most recent automatically:
```bash
python3 AI_Guidance/Tools/session_manager.py --load
```
