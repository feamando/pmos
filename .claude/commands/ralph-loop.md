...
```bash
python3 AI_Guidance/Tools/ralph_manager.py status <feature>
```
...
5. **Log iteration**
   ```bash
   python3 AI_Guidance/Tools/ralph_manager.py iteration <feature> \
...
6. **Post to Slack**
   ```bash
   python3 AI_Guidance/Tools/ralph_manager.py post-slack <feature>
   ```

7. **Check completion**
   ```bash
   python3 AI_Guidance/Tools/ralph_manager.py check-complete <feature>
   ```
...
2. Complete the work
3. Update PLAN.md
4. Run: `python3 AI_Guidance/Tools/ralph_manager.py iteration <feature> --summary "..."`
5. Repeat
