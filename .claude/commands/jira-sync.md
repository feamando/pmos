...
Fetch Jira activity (epics, in-progress, blockers) for New Ventures squads and enrich Brain context.
...
python3 AI_Guidance/Tools/jira_brain_sync.py --summarize

# Specific squad
python3 AI_Guidance/Tools/jira_brain_sync.py --squad "Good Chop"

# With GitHub PR links
python3 AI_Guidance/Tools/jira_brain_sync.py --github

# Full enrichment
python3 AI_Guidance/Tools/jira_brain_sync.py --summarize --github
```
