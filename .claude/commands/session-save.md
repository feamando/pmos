...
```bash
python3 AI_Guidance/Tools/session_manager.py --create "Session Title" \
...
```bash
python3 AI_Guidance/Tools/session_manager.py --save \
...
```bash
python3 AI_Guidance/Tools/session_manager.py --log "Completed Phase 1: Created directory structure and copied 34 commands"
```

**For decisions:**
```bash
python3 AI_Guidance/Tools/session_manager.py --decision "Include FPF system|User requested full reasoning capabilities|Minimal q0/q5 only"
```

**For open questions:**
```bash
python3 AI_Guidance/Tools/session_manager.py --question "Should /setup auto-run /create-context?"
```
