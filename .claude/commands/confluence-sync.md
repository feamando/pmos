...
```bash
python3 AI_Guidance/Tools/confluence_brain_sync.py --search "$ARGUMENTS"
```
...
```bash
python3 AI_Guidance/Tools/confluence_brain_sync.py --page $ARGUMENTS --sync
```
...
```bash
python3 AI_Guidance/Tools/confluence_brain_sync.py --space $ARGUMENTS --recent 10 --sync
```
...
```bash
python3 AI_Guidance/Tools/confluence_brain_sync.py --list-synced
```
...
```bash
python3 AI_Guidance/Tools/confluence_brain_sync.py --search "$ARGUMENTS" --sync --limit 10
```
...
**Search and sync:**
- `/confluence-sync --search "TPT app" --sync --limit 5`
...
Synced pages are saved to `AI_Guidance/Brain/Inbox/Confluence/` with format:
