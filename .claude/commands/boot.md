...
2. `Read: user/brain/BRAIN.md` (compressed entity index)
3. `Read: user/USER.md`
4. `Read: user/context/YYYY-MM-DD-context.md` (today's date)
...
### Step 4.5: Brain Enrichment (boot mode)

Run TKS-derived brain quality tools in boot mode (fast, minimal):
...
- Soft edge inference for brand, squad, team only
