...
```bash
python3 AI_Guidance/Tools/gemini_quint_bridge.py <command> [question]
```
...
python3 AI_Guidance/Tools/gemini_quint_bridge.py init "Should we migrate to microservices?"

# 2. Generate hypotheses
python3 AI_Guidance/Tools/gemini_quint_bridge.py hypothesize "What are the trade-offs of microservices vs monolith?"

# 3. Verify logical consistency
python3 AI_Guidance/Tools/gemini_quint_bridge.py verify

# 4. Gather evidence
python3 AI_Guidance/Tools/gemini_quint_bridge.py validate

# 5. Check for biases
python3 AI_Guidance/Tools/gemini_quint_bridge.py audit

# 6. Create decision record
python3 AI_Guidance/Tools/gemini_quint_bridge.py decide

# 7. Sync to Brain
python3 AI_Guidance/Tools/gemini_quint_bridge.py sync
```
