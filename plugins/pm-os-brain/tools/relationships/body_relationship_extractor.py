#!/usr/bin/env python3
"""
PM-OS Brain Body Relationship Extractor (v5.0)

Extracts relationships from entity body content by analyzing mentions
of other entities using the alias registry.

Usage:
    from pm_os_brain.tools.relationships.body_relationship_extractor import BodyRelationshipExtractor
"""
...
class BodyRelationshipExtractor:
    ...
    def _add_relationship(
        ...
        try:
            ...
            logger.error("Error adding relationship to %s: %s", source_id, e)
            return False
