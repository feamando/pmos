#!/usr/bin/env python3
"""
PM-OS Brain Extraction Hints Generator (v5.0)

Generates actionable hints about missing entity fields and which
MCP sources can provide them.

Usage:
    from pm_os_brain.tools.relationships.extraction_hints import ExtractionHintsGenerator
"""
...
class ExtractionHintsGenerator:
    ...
    Tracks expected fields and guides enrichment pipeline to fill specific gaps.
    """
